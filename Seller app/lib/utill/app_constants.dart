import 'package:Saaman_Vendor/data/model/response/language_model.dart';
import 'package:Saaman_Vendor/utill/images.dart';

class AppConstants {
  static const String APP_NAME = 'Saaman vendor';
  static const String BASE_URL = 'http://192.168.1.18/site';
  ...
  static const String TOPIC = 'saaman_seller';
