...
import 'package:Saaman_Vendor/data/model/response/order_model.dart';
...
import 'package:Saaman_Vendor/view/base/custom_button.dart';
import 'package:Saaman_Vendor/view/base/custom_divider.dart';
import 'package:Saaman_Vendor/view/base/custom_snackbar.dart';
import 'package:Saaman_Vendor/view/base/no_data_screen.dart';
import 'package:Saaman_Vendor/view/base/textfeild/custom_text_feild.dart';
...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  void _loadData(BuildContext context, String type) async {
    ...
    Provider.of<OrderProvider>(context, listen: false)
        .initOrderStatusList(context, widget.shippingType);
    Provider.of<DeliveryManProvider>(context, listen: false)
        .getDeliveryManList(widget.orderModel, context);
  }

  TextEditingController _thirdPartyShippingNameController =
      TextEditingController();

  TextEditingController _thirdPartyShippingIdController =
      TextEditingController();
                        ...
                        child: Column(
                            ...
                            children: [
                                                                    ...
                                                                    return DropdownMenuItem<
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        value !=
                                                                            ...
                                                                            : getTranslated('select_delivery_man',
                                                                                context),
                                                                        style: TextStyle(
                                                                            color:
                                                                ...
                                                                if (serviceName
                                                                  ...
                                                                  shipping.isLoading
                                                                      ? CircularProgressIndicator(
                                                                          color: Theme.of(context)
                                                                              .primaryColor)
                                                                      : Provider.of<ShippingProvider>(context, listen: false).assignThirdPartyDeliveryMan(
                                                                          context,
                                                                          serviceName,
                                                                          trackingId,
                                                                          widget
                              ...
                              Row(
                                  ...
                                  children: [
                                    Text(
                                      '${getTranslated('order_no', context)}#${widget.orderModel.id}',
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color:
                                            ColorResources.mainCardThreeColor(
                                                    context)
                                                .withOpacity(.085),
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        ...
                                        '${widget.orderModel.shippingAddressData != null ? jsonDecode(widget.orderModel.shippingAddressData)['address'] : widget.orderModel.shippingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('phone', context)} : '
                                        '${widget.orderModel.shippingAddressData != null ? jsonDecode(widget.orderModel.shippingAddressData)['phone'] : widget.orderModel.shippingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('zip_code', context)} : '
                                        '${widget.orderModel.shippingAddressData != null ? jsonDecode(widget.orderModel.shippingAddressData)['zip'] : widget.orderModel.shippingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('city', context)} : '
                                        '${widget.orderModel.shippingAddressData != null ? jsonDecode(widget.orderModel.shippingAddressData)['city'] : widget.orderModel.shippingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    SizedBox(
                                    ...
                                    Text(
                                        '${getTranslated('name', context)} : '
                                        '${widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.contactPersonName : widget.orderModel.billingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('billing_address', context)} : '
                                        '${widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.address : widget.orderModel.billingAddress ?? ''}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('phone', context)} : '
                                        '${widget.orderModel.customer != null ? widget.orderModel.customer.phone ?? '' : ""}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('zip_code', context)} : '
                                        '${widget.orderModel.billingAddressData != null ? widget.orderModel.billingAddressData.zip ?? '' : ""}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    Text(
                                        '${getTranslated('city', context)} : '
                                        '${widget.orderModel.customer != null ? widget.orderModel.billingAddressData.city ?? '' : ""}',
                                        style: titilliumRegular.copyWith(
                                            color: ColorResources.getTextColor(
                                                context))),
                                    SizedBox(
                                            ...
                                            Text(
                                                ...
                                                style: titilliumRegular.copyWith(
                                                    ...
                                                    fontSize: Dimensions
                                                        .FONT_SIZE_DEFAULT)),
                                            Text(
                                                '${getTranslated('contact', context)} : ${widget.orderModel.customer.phone}',
                                                style: titilliumRegular.copyWith(
                                                    color: ColorResources
                                                        .titleColor(context),
                                                    fontSize: Dimensions
                                ...
                                return Row(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: InkWell(
                                          onTap: () async {
                                            if (order.orderStatusType ==
                                                order.orderStatusList[0]) {
