...
import 'package:Saaman_Vendor/view/screens/addProduct/widget/add_product_next_Screen.dart';
import 'package:Saaman_Vendor/view/screens/addProduct/widget/select_category_widget.dart';
import 'package:Saaman_Vendor/view/screens/addProduct/widget/title_and_description_widget.dart';
...
class AddProductScreen extends StatefulWidget {
  ...
  AddProductScreen(
      {Key key, this.product, this.category, this.addProduct, this.editProduct})
      : super(key: key);
  @override
                          ...
                          builder: (_) => AddProductNextScreen(
                              ...
                              subCategoryId: resProvider.subCategoryIndex != 0
                                  ? resProvider
                                      ...
                                      .toString()
                                  : "-1",
                              subSubCategoryId: resProvider.subSubCategoryIndex != 0
                                  ? resProvider
                                      .subSubCategoryList[
                                  ...
                                  : "-1",
                              brandId:
                                  _brandIds[resProvider.brandIndex].toString(),
                              unit: unitValue,
                              product: widget.product,
