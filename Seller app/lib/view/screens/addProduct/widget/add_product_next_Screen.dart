...
import 'package:Saaman_Vendor/data/model/response/add_product_model.dart';
import 'package:Saaman_Vendor/data/model/response/attribute_model.dart';
import 'package:Saaman_Vendor/data/model/response/product_model.dart';
import 'package:Saaman_Vendor/data/model/response/variant_type_model.dart';
...
import 'package:Saaman_Vendor/view/base/attribute_view.dart';
...
import 'package:Saaman_Vendor/view/screens/addProduct/widget/add_product_seo_screen.dart';
  ...
  void initState() {
    ...
    if (_update) {
      ...
      _unitPriceController.text =
          PriceConverter.convertPriceWithoutSymbol(context, _product.unitPrice);
                          ...
                          children: [
                            ...
                            resProvider.attributeList[0].active
                                ? Consumer<SplashProvider>(
                                    builder: (ctx, colorProvider, child) {
                                    if (colorProvider.colorList != null) {
                                      for (int index = 0;
                                          index <
                                              colorProvider.colorList.length;
                                          index++) {
                                        _colors.add(index);
                                      }
                                    }
                                    return Autocomplete<int>(
                                      ...
                                      displayStringForOption: (value) =>
                                          colorProvider.colorList[value].name,
                                      onSelected: (int value) {
                                        resProvider.addVariant(
                                            ...
                                            widget.product,
                                            true);
                                        resProvider.addColorCode(colorProvider
                                            .colorList[value].code);
                                      },
                                    );
                                  })
                                : SizedBox(),
                            ...
                            SizedBox(
                                height: resProvider.selectedColor.length != null
                                    ? Dimensions.PADDING_SIZE_SMALL
                                    : 0),

                            SizedBox(
                              height: (resProvider.attributeList[0].variants
                                              .length !=
                                          null &&
                                  ...
                                  ? 40
                                  : 0,
                              child: (resProvider.attributeList[0].variants
                                              .length !=
                                          null &&
                                      resProvider.attributeList[0].variants
                                              .length >
                                  ...
                                  ? ListView.builder(
                                      itemCount: resProvider
                                          .attributeList[0].variants.length,
                                  ...
                                  child: Column(
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton<String>(
                                        value:
                                            resProvider.discountTypeIndex == 0
                                                ? 'percent'
                                                : 'flat',
