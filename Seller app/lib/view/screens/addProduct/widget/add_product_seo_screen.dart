...
class _AddProductSeoScreenState extends State<AddProductSeoScreen> {
    ...
    if (isRoute) {
      if (_update) {
        if (thumbnailImage == '' && metaImage == '') {
          total = Provider.of<RestaurantProvider>(context, listen: false)
              .productImage
              .length;
      ...
      if (counter == total) {
        counter++;
        Provider.of<RestaurantProvider>(context, listen: false).addProduct(
            context,
            _product,
            _addProduct,
            productImage,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  child: (resProvider.attributeList != null &&
                      ...
                      ? Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: Dimensions.PADDING_SIZE_DEFAULT),
                            ConstrainedBox(
                                constraints: resProvider.productImage.length >=
                                        4
                                    ? BoxConstraints(
                                ...
                                child: StaggeredGridView.countBuilder(
                                  ...
                                  itemCount:
                                      resProvider.productImage.length + 1,
                                  crossAxisCount: 4,
                                  staggeredTileBuilder: (int index) =>
                                      StaggeredTile.fit(1),
                                  itemBuilder: (BuildContext context, index) {
                                    return index ==
                                            resProvider.productImage.length
                                        ? GestureDetector(
                                            onTap: () => resProvider.pickImage(
                                                false, false, false),
                                            child: Stack(
      ...
      bottomNavigationBar:
          Consumer<RestaurantProvider>(builder: (context, resProvider, _) {
        return Container(
          height: 80,
              ...
              ? CustomButton(
                  ...
                  onTap: () {
                    ...
                    if (!_update && resProvider.pickedLogo == null) {
                      ...
                      _product.discountType = resProvider.discountTypeIndex == 0
                          ? 'percent'
                          : 'flat';
                        ...
                        if (resProvider.pickedLogo == null &&
                          ...
                          if (resProvider.pickedLogo != null) {
                            resProvider.addProductImage(
                                resProvider.pickedLogo, 'thumbnail', route);
                          }

                          if (resProvider.pickedMeta != null) {
                            resProvider.addProductImage(
                                resProvider.pickedMeta, 'meta', route);
                          }

                          if (resProvider.productImage != null &&
                              resProvider.productImage.length > 0) {
                            for (int i = 0;
                                i < resProvider.productImage.length;
                                i++) {
                              resProvider.addProductImage(
                                  resProvider.productImage[i],
                                  'product',
                                  route);
                            }
                          }
                      ...
                      if (resProvider.productImage != null) {
                        for (int i = 0;
                            ...
                            i++) {
                          resProvider.addProductImage(
                              resProvider.productImage[i], 'product', route);
                        }
                      }
                    }
                  },
