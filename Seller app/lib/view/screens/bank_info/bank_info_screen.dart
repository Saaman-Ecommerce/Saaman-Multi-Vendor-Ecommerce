...
import 'package:Saaman_Vendor/view/screens/bank_info/bank_editing_screen.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<BankInfoProvider>(
          builder: (context, bankProvider, child) => bankProvider.bankInfo !=
                  null
              ? Stack(
                  children: [
                    Container(
                      padding: EdgeInsets.symmetric(
                          ...
                          vertical: Dimensions.PADDING_SIZE_BUTTON),
                      child: Column(
                        ...
                        children: [
                          Row(children: [
                            Container(
                                width: Dimensions.ICON_SIZE_MEDIUM,
                          ...
                          Row(children: [
                            Container(
                                width: Dimensions.ICON_SIZE_MEDIUM,
                                height: Dimensions.ICON_SIZE_MEDIUM,
                                child: Image.asset(Images.branch,
                                    color: ColorResources.titleColor(context))),
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                          ...
                          Row(children: [
                            Container(
                                width: Dimensions.ICON_SIZE_MEDIUM,
                                height: Dimensions.ICON_SIZE_MEDIUM,
                                child: Image.asset(Images.holder,
                                    color: ColorResources.titleColor(context))),
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                          ...
                          Row(children: [
                            Container(
                                width: Dimensions.ICON_SIZE_MEDIUM,
                                height: Dimensions.ICON_SIZE_MEDIUM,
                                child: Image.asset(Images.credit_card,
                                    color: ColorResources.titleColor(context))),
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                            Text(
