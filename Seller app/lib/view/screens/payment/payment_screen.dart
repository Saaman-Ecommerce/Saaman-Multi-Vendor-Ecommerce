...
import 'package:Saaman_Vendor/view/base/textfeild/custom_pass_textfeild.dart';
      ...
      body: SafeArea(
        ...
        children: [
                  ...
                  child: Stack(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: Provider.of<OrderProvider>(context)
                                    .paymentMethodIndex ==
                                index
                            ? BoxDecoration(
                        ...
                        child: Image.asset(
                          paymentList.paymentImageList[index],
                          height: 30,
                          width: 30,
                        ),
                      ),
                      Provider.of<OrderProvider>(context).paymentMethodIndex ==
                              index
                          ? Positioned(
                              top: 5,
                              left: 5,
          ...
          Row(
            children: [
              ...
              Expanded(
                ...
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text(getTranslated('expired_date', context),
                      style: titilliumRegular.copyWith(
                        fontSize: Dimensions.PADDING_SIZE_DEFAULT,
                        color: ColorResources.getHintColor(context),
                      )),
          ...
          Padding(
            ...
            child: CustomButton(
              btnTxt: getTranslated('add_card', context),
