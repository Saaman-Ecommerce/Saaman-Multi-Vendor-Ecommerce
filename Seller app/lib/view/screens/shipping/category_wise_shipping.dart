...
import 'package:Saaman_Vendor/view/base/no_shipping_method.dart';
...
class _CategoryWiseShippingScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Consumer<ShippingProvider>(builder: (context, shipProv, child) {
          return Stack(
            children: [
              Column(
                children: [
                  ...
                  shipProv.categoryWiseShipping != null
                      ? shipProv.categoryWiseShipping.length > 0
                          ? Expanded(
                              child: ListView.builder(
                                  itemCount:
                                      shipProv.categoryWiseShipping.length,
                                  itemBuilder: (context, index) {
                                    return shipProv.categoryWiseShipping[index]
                                                .category !=
                                            null
                                        ? Container(
                                            ...
                                            child: Row(children: [
                                              Expanded(
                                                ...
                                                children: [
                                                  Container(
                                                      child: Text(
                                                          '${shipProv.categoryWiseShipping[index].category != null ? shipProv.categoryWiseShipping[index].category.name : '' ?? ''}',
                                                          maxLines: 3,
                                                          ...
                                                          onChanged: (value) {
                                                            shipProv
                                                                .toggleMultiply(
                                                                    ...
                                                                    index);
                                                            print(
                                                                '===IsMultiply=>${shipProv.isMultiply}');
                                                          },
                                                          activeColor:
                                                              Theme.of(context)
                                                                  .primaryColor,
                      ...
                      : CustomButton(
                          ...
                          onTap: () {
                            ...
                            shipProv.shippingCostController.forEach((cost) {
                              _cost.add(
                                  double.parse(cost.text.trim().toString()));
                            });
                            _ids = shipProv.ids;
                            _isMulti = shipProv.isMultiplyInt;
                            shipProv
                                .setCategoryWiseShippingCost(
                                    context, _ids, _cost, _isMulti)
                                .then((value) {
