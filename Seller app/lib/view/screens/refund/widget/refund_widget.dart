...
import 'package:Saaman_Vendor/view/screens/refund/widget/refund_details.dart';
...
class RefundWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData(
          splashColor:
              ColorResources.mainCardThreeColor(context).withOpacity(.10)),
      child: InkWell(
          ...
          children: [
            Container(
              ...
              padding: EdgeInsets.symmetric(
                  horizontal: Dimensions.PADDING_SIZE_ORDER,
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                '${getTranslated('order_no', context)}# ${refundModel.orderId.toString()}',
                              ...
                              refundModel.product != null
                                  ? Text(
                                      '${refundModel.product.name.toString()}',
                                      maxLines: 2,
                              ...
                              refundModel.product != null
                                  ...
                                  : SizedBox(),
                              Text(
                                '${getTranslated('refund_no', context)}# ${refundModel.id.toString()}',
                                style: titilliumBold.copyWith(
                                    color: ColorResources.getTextColor(context),
                                    fontSize: Dimensions.FONT_SIZE_LARGE),
                              ),
