...
import 'package:Saaman_Vendor/data/model/response/refund_model.dart';
import 'package:Saaman_Vendor/helper/date_converter.dart';
...
import 'package:Saaman_Vendor/view/base/confirmation_dialog.dart';
import 'package:Saaman_Vendor/view/base/custom_app_bar.dart';
import 'package:Saaman_Vendor/view/base/custom_divider.dart';
import 'package:Saaman_Vendor/view/base/custom_snackbar.dart';
...
class _RefundDetailScreenState extends State<RefundDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                ...
                children: [
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.only(
                              left: Dimensions.PADDING_SIZE_MEDIUM,
                          ...
                          child: Row(children: [
                            Column(
                              ...
                              children: [
                                Text(
                                  '${getTranslated('order_no', context)}# ${widget.refundModel.orderId.toString()}',
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: widget.refundModel.status == 'approved'
                              ...
                              child: Center(
                                child: Text(widget.refundModel.status,
                                    style: titilliumBold.copyWith(
                                        color: widget.refundModel.status ==
                                                'approved'
                                        ...
                                        return refund.refundDetailsModel != null
                                            ? Expanded(
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '${widget.refundModel.product.name.toString()}',
                                                      maxLines: 1,
                                                      overflow:
                                                    ...
                                                    Text(
                                                      '${PriceConverter.convertPrice(context, refund.refundDetailsModel.productPrice)}',
                                                      maxLines: 1,
                                                      overflow:
                                                          TextOverflow.ellipsis,
                                                      style: titilliumBold.copyWith(
                                                    ...
                                                    Row(
                                                      children: [
                                                        ...
                                                        Text(
                                                          '${refund.refundDetailsModel.quntity}',
                                                          maxLines: 1,
                                                          overflow: TextOverflow
                                                              .ellipsis,
                                                          style: titilliumRegular.copyWith(
                        ...
                        Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${widget.refundModel.refundReason.toString()}',
                                maxLines: 10,
                                style: titilliumRegular.copyWith(
                        ...
                        widget.refundModel.images != null &&
                                widget.refundModel.images.length > 0
                            ? Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal:
                                        Dimensions.PADDING_SIZE_DEFAULT),
                        ...
                        widget.refundModel.images != null &&
                            ...
                            ? Padding(
                                padding: const EdgeInsets.symmetric(
                                    horizontal: Dimensions.PADDING_EYE),
                                child: Container(
                                  height: Dimensions.image_size,
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (BuildContext context, index) {
                                      return widget.refundModel.images.length >
                                              0
                                          ? Padding(
                                              padding:
                              ...
                              ? Column(
                                  ...
                                  children: [
                                      Row(
                                        children: [
                                          Text(
                                            '${getTranslated('product_price', context)} (x 1)',
                                            style: titilliumRegular.copyWith(
                                                fontSize:
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                              '-${PriceConverter.convertPrice(context, refund.refundDetailsModel.productTotalDiscount)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize: Dimensions
                                                      .FONT_SIZE_LARGE,
                                                  color:
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                              '-${PriceConverter.convertPrice(context, refund.refundDetailsModel.couponDiscount)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize: Dimensions
                                                      .FONT_SIZE_LARGE,
                                                  color:
                                      ...
                                      Row(
                                        children: [
                                          Text(
                                            '${getTranslated('product_tax', context)}',
                                            style: titilliumRegular.copyWith(
                                                fontSize:
                                                    Dimensions.FONT_SIZE_LARGE,
                                                color:
                                          ...
                                          Spacer(),
                                          Text(
                                              '+${PriceConverter.convertPrice(context, refund.refundDetailsModel.productTotalTax)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize: Dimensions
                                                      .FONT_SIZE_LARGE,
                                                  color:
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                              '${PriceConverter.convertPrice(context, refund.refundDetailsModel.subtotal)}',
                                              style: titilliumRegular.copyWith(
                                                  fontSize: Dimensions
                                                      .FONT_SIZE_LARGE,
                                                  color:
                                      ...
                                      Row(
                                        children: [
                                          ...
                                          Spacer(),
                                          Text(
                                            '${PriceConverter.convertPrice(context, refund.refundDetailsModel.refundAmount)}',
                                            style: titilliumSemiBold.copyWith(
                                                color: Theme.of(context)
                                                    .primaryColor,
                                                fontSize:
                  ...
                  widget.refundModel.customer != null
                      ? Container(
                          padding: EdgeInsets.symmetric(
                              horizontal: Dimensions.PADDING_SIZE_DEFAULT,
                              vertical: Dimensions.PADDING_SIZE_MEDIUM),
                          decoration: BoxDecoration(
                            color: Theme.of(context).cardColor,
                            boxShadow: [
                              BoxShadow(
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      children: [
                                        Text(
                                            '${widget.refundModel.customer.fName ?? ''} ${widget.refundModel.customer.lName ?? ''}',
                                            style: titilliumBold.copyWith(
                                                color:
                                        ...
                                        Text(
                                            '${getTranslated('email', context)} : ${widget.refundModel.customer.email ?? ''}',
                                            style: titilliumRegular.copyWith(
                                                color:
                                                    ColorResources.titleColor(
                                                        context),
                                        ...
                                        Text(
                                            '${getTranslated('contact', context)} : ${widget.refundModel.customer.phone}',
                                            style: titilliumRegular.copyWith(
                                                color:
                                                    ColorResources.titleColor(
                                                        context),
                      ...
                      ? Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                Text(
                                    getTranslated(
                                        'deliveryman_contact_details', context),
                                    style: titilliumBold.copyWith(
                                        color: ColorResources.getTextColor(
                                            context))),
                                SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                                      ...
                                      child: CachedNetworkImage(
                                          ...
                                          placeholder: (ctx, url) =>
                                              Image.asset(
                                                  Images.placeholder_image),
                                          imageUrl:
                                              '${Provider.of<SplashProvider>(context, listen: false).baseUrls.reviewImageUrl}/delivery-man/'
                  ...
                  SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                  (refundReq.refundDetailsModel != null &&
                          refundReq.refundDetailsModel.refundRequest[0]
                                  .refundStatus !=
                              null)
                      ? Container(
                          padding: EdgeInsets.symmetric(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                    getTranslated(
                                        'refund_status_change_log', context),
                                    style: titilliumBold.copyWith(
                                        color: ColorResources.getTextColor(
                                            context))),
                                SizedBox(
                                                      ...
                                                      Text(
                                                          ...
                                                          style: titilliumRegular.copyWith(
                                                              ...
                                                              fontSize: Dimensions
                                                                  .FONT_SIZE_DEFAULT)),
                                                      Text(
                                                          '${getTranslated('updated_by', context)} : '
      ...
      bottomNavigationBar:
          Consumer<RefundProvider>(builder: (context, refundReq, _) {
        return Container(
          height: 70,
          decoration: BoxDecoration(
            color: Theme.of(context).cardColor,
            boxShadow: [
              BoxShadow(
                  color: ColorResources.getPrimary(context).withOpacity(.10),
                  spreadRadius: 5,
                  blurRadius: 3,
                  offset: Offset.fromDirection(0, 6))
            ],
          ...
          padding: EdgeInsets.symmetric(
              horizontal: Dimensions.FONT_SIZE_SMALL,
              vertical: Dimensions.PADDING_SIZE_SMALL),
          child: Row(
                    ...
                    child: InkWell(
                        onTap: () {
                          if (count > 0) {
                            showCustomSnackBar(
                                getTranslated(
                                    'you_cant_override_admin_decision',
                                    context),
                                context);
                          } else {
