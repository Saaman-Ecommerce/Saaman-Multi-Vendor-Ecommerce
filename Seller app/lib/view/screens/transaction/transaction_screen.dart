        ...
        child: Consumer<TransactionProvider>(
          ...
          return Column(
            children: [
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              '${getTranslated('select_year', context)}',
                              style: titilliumRegular.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_DEFAULT,
                                  color: ColorResources.titleColor(context)),
                            ),
                            Text(
                              '${getTranslated('select_month', context)}',
                              style: titilliumRegular.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_DEFAULT,
                                  color: ColorResources.titleColor(context)),
                            ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: DropdownButton<int>(
                                    ...
                                    items: transactionProvider.yearIds
                                        .map((int value) {
                                      return DropdownMenuItem<int>(
                                        value: transactionProvider.yearIds
                                            .indexOf(value),
                                        child: Text(
                                            value != 0
                                                ? transactionProvider
                                    ...
                                    onChanged: (int value) {
                                      transactionProvider.setYearIndex(
                                          value, true);
                                    },
                                    isExpanded: true,
                                    underline: SizedBox(),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: DropdownButton<int>(
                                    ...
                                    items: transactionProvider.monthIds
                                        .map((int value) {
                                      return DropdownMenuItem<int>(
                                        value: transactionProvider.monthIds
                                            .indexOf(value),
                                        child: Text(
                                          value != 0
                                              ? transactionProvider
                                    ...
                                    onChanged: (int value) {
                                      transactionProvider.setMonthIndex(
                                          value, true);
                                    },
                                    isExpanded: true,
                                    underline: SizedBox(),
                            ...
                            InkWell(
                              onTap: () =>
                                  transactionProvider.filterTransaction(
                                      transactionProvider.monthIndex - 1,
                                      int.parse(transactionProvider
                                          .yearList[
                                              transactionProvider.yearIndex - 1]
                                          .year),
                                      context),
                              child: Container(
                                width: MediaQuery.of(context).size.width / 4,
              ...
              Text(
                '${getTranslated('transaction_length', context)}',
