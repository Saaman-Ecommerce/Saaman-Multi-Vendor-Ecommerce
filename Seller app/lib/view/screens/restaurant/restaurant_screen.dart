...
import 'package:Saaman_Vendor/view/screens/restaurant/restaurant_settings.dart';
...
class RestaurantScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(child: Consumer<RestaurantProvider>(
            builder: (context, resProvider, child) {
          return resProvider.restaurant != null
              ? resProvider.restaurant.length > 0
                  ? ListView.builder(
                              ...
                              Row(
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Text(
                                          'Name : ${resProvider.restaurant[index].resName}',
                                        ...
                                        children: [
                                          Text('Address : ',
                                              style: titilliumBold.copyWith(
                                                  ...
                                                  fontSize: 11)),
                                          Text('3460, Pallet Street, New York',
                                              style: titilliumBold.copyWith(
                                                  color: ColorResources
                                                      .getTextColor(context),
                                                  fontSize: 11)),
