...
import 'package:Saaman_Vendor/view/screens/restaurant/shop_update_screen.dart';
import 'package:Saaman_Vendor/view/screens/restaurant/widget/all_product_widget.dart';
import 'package:Saaman_Vendor/view/screens/review/product_review_screen.dart';
...
class _ShopScreenState extends State<ShopScreen> {
  ...
  Future<void> _loadData(BuildContext context, bool reload) async {
    ...
    Provider.of<ProductProvider>(context, listen: false).initSellerProductList(
        sellerId, 1, context, languageCode,
        reload: true);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(child:
            Consumer<ShopProvider>(builder: (context, resProvider, child) {
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                          '${resProvider.shopModel.ratting.toDouble().toStringAsFixed(1) ?? ''}',
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Consumer<ProductProvider>(
                                          ...
                                          return Text(
                                            '${product.sellerProductList.length ?? '0'}',
                                            style: robotoRegular.copyWith(
                                                color:
                                                    ColorResources.getTextColor(
                                                        context),
