...
import 'package:Saaman_Vendor/data/model/response/shop_info_model.dart';
    ...
    if (Provider.of<ShopProvider>(context, listen: false).shopModel.name ==
      ...
      await Provider.of<ShopProvider>(context, listen: false)
        ...
        if (response.isSuccess) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text(
                  getTranslated('shop_info_updated_successfully', context)),
                            ...
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                    getTranslated('update_shop', context),
