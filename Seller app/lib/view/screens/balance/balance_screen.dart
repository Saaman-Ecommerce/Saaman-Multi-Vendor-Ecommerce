...
import 'package:Saaman_Vendor/view/screens/balance/widget/complete_withdraw_dialog.dart';
      ...
      body: SafeArea(
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: Stack(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image.asset(
                                orderProvider.paymentImageList[index],
                                height: 40,
                                width: 40,
                              ),
                ...
                SizedBox(height: 15),
                Text(getTranslated('enter_amount', context),
                    style: titilliumSemiBold.copyWith(
                        color: ColorResources.getTextColor(context),
                        fontSize: 16)),
                SizedBox(height: 15),
          ...
          Padding(
            ...
            child: CustomButton(
              btnTxt: getTranslated('withdraw', context),
