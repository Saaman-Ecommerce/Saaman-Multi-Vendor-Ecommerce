...
import 'package:Saaman_Vendor/view/screens/profile/profile_screen.dart';
import 'package:Saaman_Vendor/view/screens/settings/business_setting.dart';
import 'package:Saaman_Vendor/view/screens/shipping/category_wise_shipping.dart';
                    ...
                    Expanded(
                      child: ListView(
                        ...
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              if (Provider.of<ShippingProvider>(context,
                                          listen: false)
                                ...
                                showCustomSnackBar(
                                    getTranslated(
                                        'selected_product_wise_shipping',
                                        context),
                                    context,
                                    isError: false);
                              }
                                ...
                                child: Row(
                                  children: [
                                    Container(
                                        ...
                                        height: Dimensions.ICON_SIZE_DEFAULT,
                                        child:
                                            Image.asset(Images.edit_profile)),
                                    SizedBox(
                                      width: Dimensions.PADDING_SIZE_SMALL,
                                    ),
                                    Expanded(
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                  profile.userInfoModel.productCount.toString(),
                                  style: titilliumBold.copyWith(
                                      color: ColorResources.getProfileTextColor(
                                          context),
                                      fontSize:
                                          Dimensions.FONT_SIZE_MAX_LARGE)),
                              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                              Text(
                                getTranslated('total_products', context),
                                textAlign: TextAlign.center,
                                style: titilliumRegular.copyWith(
                                    color: ColorResources.getProfileTextColor(
                                        context),
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                profile.userInfoModel.ordersCount.toString(),
                                style: titilliumBold.copyWith(
                                    color: ColorResources.getProfileTextColor(
                                        context),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: Dimensions.PADDING_SIZE_SMALL),
                              Text(
                                getTranslated('days_since_joined', context),
                                textAlign: TextAlign.center,
                                style: titilliumRegular.copyWith(
                                    color: ColorResources.getProfileTextColor(
                                        context),
