          ...
          Future.delayed(Duration.zero, () async {
            for (int i = 0; i < widget.product.attributes.length; i++) {
              Provider.of<RestaurantProvider>(context, listen: false)
                  .setAttributeItemList(widget.product.attributes[i]);
            }
          });
        }
      }
      ...
      builder: (context, resProvider, child) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: resProvider.attributeList[index].active
                                ...
                                : Theme.of(context).hintColor.withOpacity(.10),
                            borderRadius: BorderRadius.circular(
                                Dimensions.PADDING_SIZE_EXTRA_SMALL),
                          ),
                          child: Text(
                            resProvider.attributeList[index].attribute.name,
                            maxLines: 2,
                                    ...
                                    Row(children: [
                                      Expanded(
                                        ...
                                        controller: resProvider
                                            .attributeList[index].controller,
          ...
          resProvider.variantTypeList.length > 0
              ...
              : SizedBox.shrink(),
          SizedBox(
              height: resProvider.variantTypeList.length > 0
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    CustomTextField(
                                      ...
                                      hintText: 'Ex: \$234',
                                      controller: resProvider
                                          .variantTypeList[index].controller,
