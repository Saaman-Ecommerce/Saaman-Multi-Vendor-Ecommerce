...
class ProductWidget extends StatelessWidget {
  ...
  final bool isHome;
  ProductWidget(
      {@required this.productModel, this.isShop = false, this.isHome = false});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Padding(
        padding:
            EdgeInsets.symmetric(horizontal: isShop ? 0 : 7.0, vertical: 4.0),
        child: Stack(
          children: [
            isShop
                ? Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (_) =>
                              AddProductScreen(product: productModel)));
                    },
                    child: Container(
