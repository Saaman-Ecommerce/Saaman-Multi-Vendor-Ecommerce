            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text(
                ...
                style: titilliumBold.copyWith(
                    color: ColorResources.COLOR_LIGHT_BLACK, fontSize: 14),
              ),
              Text('\$0.00',
                  style: titilliumBold.copyWith(
                      color: ColorResources.GAINS_BORO, fontSize: 14)),
            ]),
            Row(
              children: [
                Text('00:00',
                    style: titilliumRegular.copyWith(
                        color: ColorResources.GAINS_BORO, fontSize: 10)),
                SizedBox(width: 5),
                Text(
                  '|',
                  style: TextStyle(color: ColorResources.GAINS_BORO),
                ),
                SizedBox(width: 5),
                Text('1 items : item',
                    style: titilliumRegular.copyWith(
            ...
            Row(
              ...
              children: [
                TextButton(
                    ...
                    child: Text('Name',
                        style: titilliumBold.copyWith(
                            color: ColorResources.GAINS_BORO, fontSize: 15))),
                Expanded(child: SizedBox()),
                Text(
                  '${getTranslated('view_details', context)}',
                  style: titilliumRegular.copyWith(
                      color: ColorResources.GAINS_BORO, fontSize: 12),
                ),
                Icon(
