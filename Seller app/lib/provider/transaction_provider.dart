...
import 'package:Saaman_Vendor/data/model/response/month_model.dart';
import 'package:Saaman_Vendor/data/model/response/transaction_model.dart';
import 'package:Saaman_Vendor/data/model/response/year_model.dart';
    ...
    if (month == 1) {
      ...
      _allTransactionList.forEach((transaction) {
        ...
        if (DateConverter.getMonthIndex(transaction.createdAt) == month &&
          ...
          print(
              '==month=>${transaction.createdAt} && ==year=>$month and ${DateConverter.getYear(transaction.createdAt)}');
        }
      });
    }
    notifyListeners();
