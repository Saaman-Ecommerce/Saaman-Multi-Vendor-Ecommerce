...
import 'package:Saaman_Vendor/data/model/response/delivery_man_model.dart';
import 'package:Saaman_Vendor/data/model/response/order_model.dart';
import 'package:Saaman_Vendor/data/model/response/response_model.dart';
...
class DeliveryManProvider extends ChangeNotifier {
  ...
  Future<ResponseModel> assignDeliveryMan(
    ...
    if (apiResponse.response != null &&
      ...
      responseModel = ResponseModel(
          false, apiResponse.error['message'] ?? apiResponse.error.toString());
    }
    notifyListeners();
