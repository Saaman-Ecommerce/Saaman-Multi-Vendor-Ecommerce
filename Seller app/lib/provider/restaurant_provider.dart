...
import 'package:Saaman_Vendor/data/model/response/attr.dart';
...
import 'package:Saaman_Vendor/data/model/response/base/error_response.dart';
import 'package:Saaman_Vendor/data/model/response/brand_model.dart';
import 'package:Saaman_Vendor/data/model/response/category_model.dart';
import 'package:Saaman_Vendor/data/model/response/config_model.dart';
import 'package:Saaman_Vendor/data/model/response/edt_product_model.dart';
import 'package:Saaman_Vendor/data/model/response/product_model.dart';
import 'package:Saaman_Vendor/data/model/response/restaurant_model.dart';
import 'package:Saaman_Vendor/data/model/response/restaurant_view_model.dart';
...
class RestaurantProvider extends ChangeNotifier {
    ...
    if (_restaurant == null) {
      ...
      if (apiResponse.response != null &&
        ...
        apiResponse.response.data
            .forEach((restaurant) => _restaurant.add(restaurant));
      } else {
  ...
  Future addProductImage(
      XFile pickedLogo, String type, Function callback) async {
    _isLoading = true;
    notifyListeners();
  ...
  Future<void> addProduct(
    ...
    ApiResponse response = await restaurantRepo.addProduct(
        product,
        addProduct,
        _fields,
        productImages,
