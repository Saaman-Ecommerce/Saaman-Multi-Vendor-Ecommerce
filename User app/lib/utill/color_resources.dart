...
class ColorResources {
  ...
  static Color getColombiaBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF14D2D2) : Color(0xFF008080);
  }
  static Color getLightSkyBlue(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFc7c7c7) : Color(0xFF008080);
  }
  ...
  static Color getTextTitle(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFFFFFFFF) : Color(0xFF0C4A4A);
  }
  ...
  static Color getSellerTxt(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF70BDBD) : Color(0xFF008080);
  }
  ...
  static Color couponColor(BuildContext context) {
    return Provider.of<ThemeProvider>(context).darkTheme ? Color(0xFF9CDEDE) : Color(0xFF9CDEDE);
  }
  ...
  static const MaterialColor PRIMARY_MATERIAL = MaterialColor(0xFF0C4A4A, colorMap);
}
